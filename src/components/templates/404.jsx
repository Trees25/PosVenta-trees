      ...
      <section className="home">
        <div className="home__container container">
          <div className="home__data">
            <span className="home__subtitle">Esta pagina</span>
            <h1 className="home__title">NO EXISTE</h1>
          ...
          <div className="home__img">
            <img src="https://cocosolution.com/cms/uploads/error_g9f83e8d74_640_1_.png" alt="" />
          </div>
        </div>
      </section>
    </Container>
